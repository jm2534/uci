...
impl Board {
    ...
    pub fn bishop_moves(&self, tile: Tile) -> Bitset {
...
mod tests {
    ...
    fn test_bishop_unblocked_moves() {
        ...
        let moves = board.bishop_moves(Tile::D4);
    ...
    fn test_bishop_blocked_moves() {
        ...
        let moves = board.bishop_moves(bishop_pos);
    ...
    fn test_bishop_corner_position() {
        ...
        // Test from a1
        let moves = board.bishop_moves(Tile::A1);
        assert_eq!(moves.len(), 7); // Only one diagonal

        // Test from h8
        let moves = board.bishop_moves(Tile::H8);
